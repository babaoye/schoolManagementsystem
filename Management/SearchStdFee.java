 ...
 * @author USER1
 */
public class SearchStdFee extends javax.swing.JFrame {

    int xx;
    int xy;
    /**
     * Creates new form SearchStdFee
     */
    public SearchStdFee() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Jan", "Feb", "March", "April", "May", "June", "July", "August", "September", "October", "November", "September", "October", "November", "December" }));
        ...
        jlabel_username.setText("Search Student Fee Details(Junior School)");
        ...
        setSize(new java.awt.Dimension(990, 663));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(SearchStdFee.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchStdFee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchStdFee().setVisible(true);
            }
        });
    }
